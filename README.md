...
and password (serial number):
```
from solaxlocal import SolaxLocal, X1HybridG4
inverter = X1HybridG4(ipaddress='192.168.0.101', pwd='ABCDEFGHIJ')
```
...
(field000 to field 199). Also includes calculated fields and their units.
